...
Corre step005_walk_forward_cv_3 (v3) o step005_walk_forward_cv_4 (v4) para
las 8 combinaciones de configuración:
...
def main():
    ...
    logger.info("=" * 70)
    logger.info(f"STEP005 — ITERACIÓN DE CONFIGURACIONES  ({n} combinaciones)  [VERSION={VERSION}]")
