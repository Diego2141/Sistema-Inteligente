...
Arquitectura
------------
step007 SOLO produce el ajuste diario (peor_total por fecha).
step005 lee ese ajuste y aplica el factor a sus predicciones.

Output de step007
-----------------
    Ejecutar step007 genera:
        2. Output/analisis_cc/saldos_retiros_bancos.xlsx
            tab "Ajuste_diario": columna peor_total por fecha de negocio.

    step005 lee ese archivo y aplica _aplicar_overlay_sobreencaje().
