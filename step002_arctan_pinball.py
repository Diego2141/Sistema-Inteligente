# -*- coding: utf-8 -*-
"""
step002_arctan_pinball.py
Script de referencia para quantile regression con LightGBM.
Cubre: regresión cuantílica lineal (statsmodels) → LightGBM no lineal →
multi-feature → optimización Bayesiana (Optuna) → corrección de monotonicidad.

Fuente: Aux_XGBoost.py (rama main, autor: 2577, 14-May-2026)
"""
